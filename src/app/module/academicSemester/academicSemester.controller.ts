...
const createSemesterIntoDb = catchAsync(
...
const getSemesterIntoDb = catchAsync(
  async (req: Request, res: Response, next: NextFunction) => {
...
const getSingleSemesterIntoDb = catchAsync(
  async (req: Request, res: Response, next: NextFunction) => {
...
const updateAcademicSemesterInfo = catchAsync(
  async (req: Request, res: Response, next: NextFunction) => {
    const id = req.params.id;
    const data = req.body;
